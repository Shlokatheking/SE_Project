 ...
 function UserRegisterPageWOImage(props) {
   return (
     <UserRegisterPageWOIm className={props.className}>
       ...
       <FrameButtons>
         <ButtonPrimary topMargin={"30px"} title={"Register"}  width={`327px`} endPoint={'start-up-landing-page'}></ButtonPrimary>
         <ButtonPrimary topMargin={"110px"} title={"Sign-In"} width={`327px`} ></ButtonPrimary>
       </FrameButtons>
